...
class BotManager {
    constructor() {
        this._0x2a7c=[]; this._0x5f8e=process.env.GAME_SERVER||''; this._0x1d3b=process.env.GAME_ORIGIN||'http://localhost';
        this._0x4c6f=null; this._0x8a2e=null; this._0x3e1a=0; this._0x9f2c=numberEnv('MAX_BOTS',100,1,1000); this.spawnDelay=numberEnv('SPAWN_DELAY_MS',250,50,5000);
    ...
    clearTarget(){this.targetName='';this.targetXPos=null;this.targetYPos=null;for(const bot of this._0x2a7c)bot.setTarget(null,null);}
    ...
    setBoostState(v){this._0xboostState=!!v;for(const b of this._0x2a7c)b.boostSpeed(this._0xboostState);}
    setCosmetic(v){this._0x5b7c=Number(v)||11;for(const b of this._0x2a7c)b.cosmetic=this._0x5b7c;}
    setTag(v){this._0x9d1e=Number(v)||12;for(const b of this._0x2a7c)b.tag=this._0x9d1e;}
